...
cfg = {
    ...
    "wandb": {"with_media_logging": True, "project": None, "name": None, "group": None},
    "slurm": {
        "gpus": 4,
        "mem_per_gpu": 40,
        "time": 3600,
    ...
    "datasource": {
        ...
        "max_channels": 2,
        "train": "/home/nate/audiocraft/egs/example",
        "valid": "/home/nate/audiocraft/egs/example",
        "evaluate": "/home/nate/audiocraft/egs/example",
        "generate": "/home/nate/audiocraft/egs/example",
    },
    "solver": "musicgen",
    "fsdp": {
        "use": False,
    ...
    "dataset": {
        ...
        "train": {
            ...
            "merge_text_p": 0.25,  # Probability of merging additional metadata to the description.
            "drop_desc_p": 0.5,  # Probability of dropping the original description on text merge.
            "drop_other_p": 0.5,  # Probability of dropping the other fields used for text augmentation.
        },
        "valid": {"num_samples": 10000},
        "evaluate": {"num_samples": 10000},
        "generate": {"num_samples": 50, "return_info": True},
    },
